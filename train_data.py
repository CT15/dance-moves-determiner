...
def load(with_names=False):
    ...
    kaiyan_wipers_nov_df = prepare_data('kaiyan_wipers_2.5min_nov', 1)
    kaiyan_number7_nov_df = prepare_data('kaiyan_number7_2.5min_nov', 2)
    kaiyan_chicken_nov_df = prepare_data('kaiyan_chicken_2.5min_nov', 3)
    kaiyan_sidestep_nov_df = prepare_data('kaiyan_sidestep_2.5min_nov', 4)
    kaiyan_turnclap1_nov_df = prepare_data('kaiyan_turnclap1_1min_nov', 5)
    kaiyan_turnclap2_nov_df = prepare_data('kaiyan_turnclap2_1min_nov', 5)
    kaiyan_number6_nov_df = prepare_data('kaiyan_number6_2.5min_nov', 6)
    kaiyan_salute_nov_df = prepare_data('kaiyan_salute_2.5min_nov', 7)
    kaiyan_mermaid_nov_df = prepare_data('kaiyan_mermaid_2.5min_nov', 8)
    kaiyan_swing_nov_df = prepare_data('kaiyan_swing_2.5min_nov', 9)
    kaiyan_cowboy1_nov_df = prepare_data('kaiyan_cowboy1_1min_nov', 10)
    kaiyan_cowboy2_nov_df = prepare_data('kaiyan_cowboy2_1min_nov', 10)
    kaiyan_finalmove_nov_df = prepare_data('kaiyan_finalmove_2.5min_nov', 11)
