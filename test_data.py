...
def load(with_names=False):
    ...
    sarah_turnclap1_test = prepare_data('sarah_turnclap1_1min', 4)
    sarah_turnclap2_test = prepare_data('sarah_turnclap2_1min', 4)
    ...
    sarah_cowboy1_test = prepare_data('sarah_cowboy1_1min', 9)
    sarah_cowboy2_test = prepare_data('sarah_cowboy2_1min', 9)
